...
- エージェント・エネミー画像をマウスホバーした時に黄色枠で強調されるように変更
- リザルトカードをマウスホバーした時に強調されるように変更
- 言語セレクト内にアイコンを追加
...
#### Added
- 言語セレクトの開閉アニメーションを追加
- カスタムセレクトに `TabIndex` を付与

#### Changed
- 言語セレクトのリスト内表記をフル表記で表示
- ツールチップをホバーしてから1秒後に表示するように変更