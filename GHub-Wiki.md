...
## 主な機能
通常ダメージと状態異常ダメージを算出できます。
※ここで言う通常ダメージは状態異常や混沌を除く攻撃によって発生したダメージを指します。内部的な計算においては同じなため、便宜上そう呼称することとしています。

会心が発生していない『非会心ダメージ』や、会心が発生した『会心ダメージ』、会心率と会心ダメージからなる会心期待値による『会心期待値ダメージ』をそれぞれ計算結果に表示します。
※状態異常ダメージは会心が発生しないので『期待値』のダメージのみを表示します。

言語を切り替えることができます。現在は日本語と英語の2言語のみ対応しています。
