...
- [ ] サイトシェア機能の実装
- [ ] 新規エージェントを追加する  
  - 照、葉瞬光、千夏、アリア、南宮羽、シーシィア
- [ ] エネミー情報を自由戦闘に登場する敵とボス級のみに絞る
  - ティルヴィング、アルペカ、既修者、盗猟犯、ハティ、ファールバウティ、狂乱暴徒、札付き殴り屋、タナトス、デュラハン、「ガーディアンⅡ型」 
  - 始まりの主
- [ ] Tooltip 修正
- [ ] main.js 分割

## 📚 References / Resources
作成にあたり、参考にさせていただいた文献になります。
...
## 📜 License
本プロジェクトは主に <ins>**個人利用**</ins> を目的としています。  
再配布または商用利用は禁止されています。

© 2025-2026 [Maybe515](https://www.hoyolab.com/accountCenter/postList?id=144180942). All rights reserved.  
